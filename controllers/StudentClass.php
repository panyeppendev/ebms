...
class StudentClass extends CI_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->library('form_validation');
        $this->load->model('StudentClassModel', 'sm');
    ...
    public function index()
    {
        ...
        $this->load->view('studentclass/studentclass', $data);
    }
    ...
    public function getdata()
    {
        ...
        $this->load->view('studentclass/ajax-data', $data);
    }
    ...
    public function detaildata()
    {
        ...
        $this->load->view('studentclass/ajax-detail', $data);
    }
	...
	{
		$data = $this->db->get_where('students', ['status' => 'AKTIF'])->result_object();
		if ($data) {
			foreach ($data as $d) {
