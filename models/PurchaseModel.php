...
class PurchaseModel extends CI_Model
{
    ...
    public function getRole()
    {
        ...
        if ($role == 'KASIR-TOKO') {
            $pocketText = 'POCKET_CANTEEN';
            $depositText = 'DEPOSIT_CANTEEN';
        } else if ($role == 'STORE') {
            $pocketText = 'POCKET_STORE';
            $depositText = 'DEPOSIT_STORE';
        } elseif ($role == 'LIBRARY') {
            $pocketText = 'POCKET_LIBRARY';
            $depositText = 'DEPOSIT_LIBRARY';
        } else {
            $pocketText = 0;
            $depositText = 0;
        }
