<div class="col-12">
    <div class="card" style="height: 71.8vh;">
        ...
        <div class="card-footer justify-content-between">
            ...
            <a class="float-right" href="<?= base_url() ?>student/behind" target="_blank"> KTS Belakang</a>
            <a class="float-right mr-3" href="<?= base_url() ?>student/ktwsbehind" target="_blank"> KTWS Belakang</a>
        </div>
    </div>
</div>