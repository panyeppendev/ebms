                ...
                <table class="tablestripped table-xl">
                    ...
                    <tbody>
                        ...
                        if ($data) {
							...
							$total = 0;
                            $text = [
                                'OBLIGATION' => 'Pasal I ayat ',
                                'PROHIBITION' => 'Pasal II ayat '
                            ];
							$status = [
								'LOW' => 'Ringan',
								'MEDIUM' => 'Sedang',
                        ...
                        <tr>
							...
							<td><?= $d->father ?></td>
							<td><?= $text[$d->type].$d->clause ?></td>
							<td><?= $d->constitution ?></td>
							<td class="text-center"><?= $status[$d->category] ?></td>
						</tr>
                        <?php
                            }
                        }else{
							echo '<tr><td colspan="7" class="text-center">Tidak ada data untuk ditampilkan</td></tr>';
						}
                        ?>
                    </tbody>
                </table>
