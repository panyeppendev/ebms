                        ...
                        <td>
                            <b>
                                ...
                                if ($transport <= 0) {
                                    ...
                                    $package = $data[0]->package . ' + Transport';
                                }
                                echo $package;
                                ?>
                            </b>
                ...
                <table class="tablestripped table-xl">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 35%" colspan="2">JUMLAH</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                    ...
                    <tfoot>
                        ...
                        <th>Rp.</th>
                        <th><?= number_format($data[0]->amount, 0, ',', '.') ?></th>
                    </tfoot>
                </table>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    Panyeppen, <?= dateHijriFormat($data[0]->created_at_hijriah) ?> H <br>
                    Kasir <br>
