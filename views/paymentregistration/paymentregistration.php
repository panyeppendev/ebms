...
<form action="<?= base_url() ?>paymentregistration/printone" method="post" target="_blank" id="form-print">
...
<?php $this->load->view('paymentregistration/js-paymentregistration'); ?>
