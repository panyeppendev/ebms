                ...
                <div class="card mb-0">
                    <div class="card-body box-profile pt-5">
                        <div class="text-center mb-5">
                            ...
                            ?>
                            <img id="avatar-profile" src="<?= $avatar ?>" alt="IMAGE OF" style="width: 200px" class="profile-user-img img-fluid img-circle">
                        </div>
                        <hr>
                        <form method="post">
                            <div class="form-group mb-0">
                                <div class="btn btn-default btn-sm btn-file" style="width: 100%;">
                ...
                <dl class="row">
                    ...
                    <dd class="col-sm-10">
                        ...
                        <div class="row mt-2 pl-2 d-none" id="wrap-change-username">
                            ...
                            <input type="text" class="form-control form-control-sm" name="username" id="username" style="width: 20%" autocomplete="off">
                            <button onclick="saveUsername('<?= $username ?>')" class="btn btn-default btn-xs px-3 ml-2">Simpan</button>
