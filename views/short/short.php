    ...
    <?php if ($setting == 'CLOSED') { ?>
        ...
        <?php } else { ?>
            <div class="row">
                ...
                <div class="col-2">
                    <a href="<?= base_url() ?>short/add" class="btn btn-primary btn-sm btn-block">
            ...
            <div class="row justify-content-end">
                <div class="col-3" id="show-count-permission"></div>
                <div class="col-4">
				...
				<div class="col-2">
					<button class="btn btn-sm btn-block btn-primary" data-toggle="modal" data-target="#modal-doback">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input data-inputmask="'mask' : '999999999999999'" data-mask="" type="text" id="nis-doback" class="form-control">
					</div>
				</div>
...
<?php $this->load->view('short/js-short'); ?>
