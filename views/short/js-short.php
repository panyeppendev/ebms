...
<script>
    ...
    const loadPermission = () => {
        ...
        $.ajax({
            url: '<?= base_url() ?>short/loadpermission',
            method: 'POST',
            data: {
                name,
                status
    ...
    const loadCountPermission = () => {
        ...
        let status = $('#changeStatus').val()
        $.ajax({
            url: '<?= base_url() ?>short/loadcountpermission',
            method: 'POST',
            data: {
                name,
                status
	...
	$('#change-constitution').on('change', function () {
		...
		$.ajax({
			url: '<?= base_url() ?>short/loadconstitution',
			method: 'POST',
	...
	const savePunishment = () => {
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: '<?= base_url() ?>short/savepunishment',
					method: 'POST',
	...
	const getIdPermission = nis => {
	  	$.ajax({
			url: '<?= base_url() ?>short/getidpermission',
			method: 'POST',
			data: {
				nis
			},
